...
contextBridge.exposeInMainWorld('tracksling', {
  ...
  getProjectInfo: () => ipcRenderer.invoke('tracksling:getProjectInfo'),
  getRuntimeInfo: () => ipcRenderer.invoke('tracksling:getRuntimeInfo'),
  newProject: () => ipcRenderer.invoke('tracksling:newProject'),
  openProject: () => ipcRenderer.invoke('tracksling:openProject'),
  saveProject: () => ipcRenderer.invoke('tracksling:saveProject'),
  saveProjectAs: () => ipcRenderer.invoke('tracksling:saveProjectAs'),
  openProjectFolder: () => ipcRenderer.invoke('tracksling:openProjectFolder'),
